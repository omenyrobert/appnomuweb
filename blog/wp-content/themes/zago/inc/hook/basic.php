...
if( ! function_exists( 'zago_primary_navigation_fallback' ) ) :
	 ...
	 * @since 1.0.0
	 */
	function zago_primary_navigation_fallback() {
		
		echo '<ul>';
			echo '<li><a href="' . esc_url( home_url( '/' ) ) . '">' .esc_html__( 'Home', 'zago' ). '</a></li>';
			wp_list_pages( array(
			'title_li' => '',
			'depth'    => 1,
			'number'   => 5,
...
/**
 * Class zago_Dropdown_Taxonomies_Control
 */
class Zago_Dropdown_Taxonomies_Control extends WP_Customize_Control {
    ...
    public function render_content() {
        $dropdown = wp_dropdown_categories(
            array(
                'name'              => 'zago-dropdown-categories-' . $this->id,
                'echo'              => 0,
                'show_option_none'  => __( '&mdash; Select &mdash;', 'zago' ),
                'option_none_value' => '0',
                'selected'          => $this->value(),
                'hide_empty'        => 0,                   
...
class Zago_Switch_Control extends WP_Customize_Control{
    public $type = 'switch';
 ...
 */
class Zago_Repeater_Text_Control extends WP_Customize_Control {
     ...
     * @var string
     */
    public $type = 'zago-repeater-text';
    ...
    public function render_content() {
        ...
        <label class="repeater-text-input">
            ...
            <a href="#" class="button button-primary btn-add-field"><?php esc_html_e( 'Add New', 'zago' ) ?></a>
        </label><!-- .repeater-text-input -->
        <?php
    }
}

class Zago_Range_Value_Control extends WP_Customize_Control {
  ...
  public function enqueue() {
    wp_enqueue_script( 'zago-customizer-range', get_template_directory_uri() . '/assets/js/customizer-range.js', array( 'jquery' ), rand(), true );
  }
  /**
   * Render the control's content.
   *
 ...
 * @access public
 */
class Zago_Customize_Section_Upsell extends WP_Customize_Section {
