...
class Zago_Dropdown_Chooser extends WP_Customize_Control{
	...
	public function render_content(){
		...
		?>
            <label>
                ...
                <select class="zago-chosen-select" <?php $this->link(); ?>>
                    <?php
...
Class Zago_Customize_Horizontal_Line extends WP_Customize_Control {
    public $type = 'hr';
...
class Zago_Multi_Input_Custom_Control extends WP_Customize_Control {
    /**
     * Control type
     *
     * @var string
...
class Zago_Note_Control extends WP_Customize_Control {
