...
( function( $, api ) {
    ...
    api.controlConstructor['zago-repeater-text'] = api.Control.extend({
        ...
        // upsell 
    api.sectionConstructor['zago-upsell'] = api.Section.extend( {
...
*/
 jQuery(document).ready(function($) {
    // $('#zago-img-container li label img').click(function(){       
    //     $('#zago-img-container li').each(function(){
    //         $(this).find('img').removeClass ('zago-radio-img-selected') ;
    //     });
    //     $(this).addClass ('zago-radio-img-selected') ;
    // }); 
    ...
    $( document ).on( 'click', '.customize_multi_add_field', zago_customize_multi_add_field )
        .on( 'change', '.customize_multi_single_field', zago_customize_multi_single_field )
        .on( 'click', '.customize_multi_remove_field', zago_customize_multi_remove_field )
    ...
    $('#customize-control-theme_options-layout_options_blog #zago-img-container li label img').click(function(){      
        $('#customize-control-theme_options-layout_options_blog #zago-img-container li').each(function(){
            $(this).find('img').removeClass ('zago-radio-img-selected') ;
        });
        $(this).addClass ('zago-radio-img-selected') ;
    });  

    $('#customize-control-theme_options-layout_options_archive #zago-img-container li label img').click(function(){       
        $('#customize-control-theme_options-layout_options_archive #zago-img-container li').each(function(){
            $(this).find('img').removeClass ('zago-radio-img-selected') ;
        });
        $(this).addClass ('zago-radio-img-selected') ;
    });  

    $('#customize-control-theme_options-layout_options_page #zago-img-container li label img').click(function(){      
        $('#customize-control-theme_options-layout_options_page #zago-img-container li').each(function(){
            $(this).find('img').removeClass ('zago-radio-img-selected') ;
        });
        $(this).addClass ('zago-radio-img-selected') ;
    });  

    $('#customize-control-theme_options-layout_options_single #zago-img-container li label img').click(function(){        
        $('#customize-control-theme_options-layout_options_single #zago-img-container li').each(function(){
            $(this).find('img').removeClass ('zago-radio-img-selected') ;
        });
        $(this).addClass ('zago-radio-img-selected') ;
    });    

    function zago_customize_multi_add_field(e) {
        ...
        e.preventDefault();
            ...
            zago_customize_multi_write( $control );
    }

    function zago_customize_multi_single_field() {
        var $control = $( this ).parents( '.customize_multi_input' );
        zago_customize_multi_write( $control );
    }

    function zago_customize_multi_remove_field(e) {
        e.preventDefault();
        var $this = $( this );
        var $control = $this.parents( '.customize_multi_input' );
        $this.parent().remove();
    ...
    function zago_customize_multi_write( $element) {
