...
?>
<?php 
$enable_video = zago_get_option( 'single_page_video_enable' );
$enable_image = zago_get_option( 'single_page_image_enable' );
$enable_header_image     = zago_get_option( 'single_page_header_image_enable' ); ?>
