...
<head>
    ...
    <title>Appnomu Reset Password</title>
                ...
                <table border="0" align="center" width="590" cellpadding="0" cellspacing="0" class="container590">
                    ...
                    <tr>
                        <td align="center" style="color: #343434; font-size: 24px; font-family: Quicksand, Calibri, sans-serif; font-weight:700;letter-spacing: 3px; line-height: 35px;"
                            ...
                            Appnomu <span style="color: #5caad2;">Account Manager</span>
                            ...
                            <table border="0" width="590" align="center" cellpadding="0" cellspacing="0" class="container590">
                                <tr>
                                    <td align="left" style="color: #888888; font-size: 16px; font-family: 'Work Sans', Calibri, sans-serif; line-height: 24px;">
                                        ...
                                        <p style="line-height: 24px;margin-bottom:15px;">
                                            A password reset instruction has been requested on your Appnomu account. If that was you please use this Code : "{{$code ?? ' '}}" as your authentication code. If that was not you, simply ignore this message and nothing will happen to your account.</br> For Account Alert and any related emergency or suspicious activity on your account, email help@appnomu.net and we will secure your account.
                                        </p>
