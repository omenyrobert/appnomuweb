                                                                                    ...
                                                                                    <td align="left" valign="middle" style="word-break: break-word; border-collapse: collapse !important; vertical-align: top;">
                                                                                        <a href="https://facebook.com/" title="Facebook" target="_blank">
                                                                                            <img 
                                                                                                ...
                                                                                                src=" https://appnomu.com/assets/img/image-8.png"
                                                                                                alt="Facebook"
                                                                                                title="Facebook"
                                                                                                width="32"
                                                                                                style="
                                                                                ...
                                                                                <tr style="vertical-align: top;">
                                                                                    <td align="left" valign="middle" style="word-break: break-word; border-collapse: collapse !important; vertical-align: top;">
                                                                                        <a href="https://twitter.com/" title="Twitter" target="_blank">
                                                                                            <img
                                                                                                src=" https://appnomu.com/assets/img/image-7.png"
                                                                                                alt="Twitter"
                                                                                                title="Twitter"
                                                                                                width="32"
                                                                                                style="
                                                                                ...
                                                                                <tr style="vertical-align: top;">
                                                                                    <td align="left" valign="middle" style="word-break: break-word; border-collapse: collapse !important; vertical-align: top;">
                                                                                        <a href="https://youtube.com/" title="YouTube" target="_blank">
                                                                                            <img
                                                                                                src=" https://appnomu.com/assets/img/image-3.png"
                                                                                                alt="YouTube"
                                                                                                title="YouTube"
                                                                                                width="32"
                                                                                                style="
                                                                                ...
                                                                                <tr style="vertical-align: top;">
                                                                                    <td align="left" valign="middle" style="word-break: break-word; border-collapse: collapse !important; vertical-align: top;">
                                                                                        <a href="https://skype.com/" title="Skype" target="_blank">
                                                                                            <img
                                                                                                src="https://appnomu.com/assets/img/image-6.png"
                                                                                                alt="Skype"
                                                                                                title="Skype"
                                                                                                width="32"
                                                                                                style="
                                                            ...
                                                            <td style="overflow-wrap: break-word; word-break: break-word; padding: 10px; font-family: 'Open Sans', sans-serif;" align="left">
                                                                <div class="v-text-align" style="color: #7e7e81; line-height: 150%; text-align: center; word-wrap: break-word;">
                                                                    <p style="font-size: 14px; line-height: 150%;">
                                                                        <span style="font-size: 12px; line-height: 18px;">You have received this email as a confirmation for registration on Appnomu</span>
                                                                    </p>
                                                                    <p style="font-size: 14px; line-height: 150%;">
                                                                        <span style="font-size: 12px; line-height: 18px;">
                                                                            You can <strong><span style="text-decoration: underline; font-size: 12px; line-height: 18px; color: #66636a;">unsubscribe </span></strong>from these emails here
                                                                            (Don't worry, we won't take it personally).
                                                                        </span>
                                                                    </p>
                                                                    <p style="font-size: 14px; line-height: 150%;">
                                                                        <span style="font-size: 12px; line-height: 18px;">4321 Area Ave.&nbsp; I&nbsp; Kampala 2345&nbsp; I&nbsp;  Uganda. </span>
                                                                    </p>
                                                                    <p style="font-size: 14px; line-height: 150%;"><span style="font-size: 12px; line-height: 18px;">Appnomu Uganda: 07094561</span></p>
                                                                    <p style="font-size: 14px; line-height: 150%;"><span style="font-size: 12px; line-height: 18px;">&copy; Appnomu. Inc. </span></p>
                                                                </div>
                                                            </td>
                                                        </tr>
                                                    </tbody>
